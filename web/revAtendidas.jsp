<%-- 
    Document   : revAtendidas
    Created on : 21/09/2017, 05:53:17 PM
    Author     : Corei3
--%>
...
<html>
    ...
    <body>
        <%
            if (nombreUsuario != null) {
        %>
        <div align="left"><img src="images/global.jpg">  <img src="images/fu.jpg" align="right"> <h2 align="center">Revisiones Atendidas</h2></div>
        <hr>
        <%
...
.                  <a href="logistica.jsp">Regresa a Inicio</a>
        ...
        <form method="post" action="consulta.do" name="" id="">
            ...
            <input type="text" name="revAtendidas" id="revAtendidas" value="3" hidden="">
