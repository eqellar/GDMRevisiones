<%-- 
    Document   : detallesNoedit
    Created on : 28/09/2017, 07:59:07 PM
    Author     : Corei3
--%>
...
<html>
    ...
    <body>
        <div align="left"><img src="images/global.jpg">  <img src="images/fu.jpg" align="right"> <h2 align="center">Solicitud ¡<%=estatus%>!</h2></div>        
        <hr>
        <a href="principal.jsp">Ir a todas la revisiones</a>
        <hr>
